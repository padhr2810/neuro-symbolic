...
"""
Every time you run this module, a new subdirectory is created inside the "mlruns/0" subdirectory.
The subdirectory contains subdirectories for: "artifacts", "metrics", "params", "tags"
"""
...
import mlflow.sklearn
	# The mlflow.sklearn module provides an API for logging and loading scikit-learn models.
from mlflow.models import infer_signature
	...
	# you can explicitly attach a signature object to your model. This is done by passing a signature object to your log_model or save_model function. You can manually create a model signature object or use the infer_signature function to generate it from datasets with valid model inputs (for instance, a training dataset minus the target column), valid model outputs (such as predictions made on the training dataset), and valid model parameters.
...
if __name__ == "__main__":
    ...
    mlflow.log_param("l1_ratio", l1_ratio)
        		# log_param() logs a single key-value param in the currently active run. The key and value are both strings. Use mlflow.log_params() to log multiple params
