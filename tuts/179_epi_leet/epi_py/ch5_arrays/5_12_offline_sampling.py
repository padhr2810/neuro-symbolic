"""
TRICK
CAN USE "random.randint()" IN A LOOP - SELECT FROM 'i' TO THE END OF ARRAY.
MOVE THE SELECTED ONE TO THE FRONT.
UPDATE THE LOWER BOUND EACH TIME TO ENSURE DON'T PICK THE SAME NUMBER MULTIPLE TIMES.
"""
