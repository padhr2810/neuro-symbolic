"""
TRICK #1: SINGLE PASS, SORT EACH PAIR OF VALUES... BUT IT'S "REVERSE SORT" IF INDEX OF FIRST VALUE IS ODD.
TRICK #2: KINDA SIMILAR TO ONE PASS OF "BUBBLE SORT" EXCEPT ADD THE REVERSE FOR EVERY SECOND VALUE.
"""
