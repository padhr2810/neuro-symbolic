"""
TRICK
100% PROBABILITY OF SELECTING THE FIRST 'k' ELEMENTS.
THEN NEED TO HANDLE STREAMED DATA ONE VALUE AT A TIME.
FOR EVERY NEW VALUE YOU GET FROM STREAM, INCREMENT THE DENOMINATOR I.E. += 1.
IN PRACTICE, THEN SELECT ONE NUMBER FROM ALL THE NUMBERS YOU'VE SEEN THUS FAR (I.E. DENOMINATOR OF PROBABILITY)
IF THE NUMBER < K THEN MOVE THE NEWEST VALUE FROM THE STREAM INTO THE SELECTED SUBSET. 
BUT IF THE NUMBER YOU SELECTED > K, JUST IGNORE IT. 
"""
