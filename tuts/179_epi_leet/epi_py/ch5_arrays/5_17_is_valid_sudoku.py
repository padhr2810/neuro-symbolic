"""
TRICK
WRITE A SIMPLE FUNCTION "has_duplicates()" THAT CHECKS IF 9 NUMBERS HAVE ANY DUPLICATES (FIRST FILTER OUT ZEROES WHICH REPRESENT UNFILLED SQUARES) 
THEN USE THIS SIMPLE FUNCTION UP TO 27 TIMES (I.E. FOR ALL ROWS / COLUMNS / SQUARES)
BUT EXIT EARLY WITH "False" IF FIND ANY DUPLICATES
"""
